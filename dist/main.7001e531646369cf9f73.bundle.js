...
function gg() {
  ...
  divError1.innerHTML = '';
  var divError2 = document.createElement('div');
  ...
  button.addEventListener('click', function () {
    ...
    if (isNum(String(num1.value)) === false && isNum(String(num2.value)) === false) {
      ...
      document.querySelector('#result').innerHTML = String(decimal_js__WEBPACK_IMPORTED_MODULE_0___default().Decimal.add(num1.value, num2.value));
    }
  });
}
